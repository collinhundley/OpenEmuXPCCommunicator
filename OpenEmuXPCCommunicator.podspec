...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Konstantin Gonikman"
  # spec.authors            = { "Konstantin Gonikman" => "info@alstertouch.de" }
  # spec.social_media_url   = "https://twitter.com/Konstantin Gonikman"
  ...
  spec.source       = { :git => "https://github.com/CocoaPriest/OpenEmuXPCCommunicator", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "OpenEmuXPCCommunicatorAgent/**/*.{h,m}", "OpenEmuXPCCommunicator/**/*.{h,m}"
